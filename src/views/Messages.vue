                            ...
                            <div class="chat-message mt-2">
                                <ul class="chat" v-for="data in messages_selected" :key="data.id">
                                    <li class="left row mx-0 mb-4 " v-if="data.type_user == 'to'">
                                        <div class="col-2 p-0">
                                            <b-avatar class="m-auto"   size="4rem" v-if="data.type == 'au'" src="http://via.placeholder.com/640x480.png/008811?text=user"></b-avatar>
    ...
    export default {
        ...
        watch:{
            type: function () {
              ...
              else  this.messages_selected = this.messages_u
            },
        ...
        computed: {
            messages_m: function () {
                let a = this.messages.filter(m => {
                    return (m.type == 'am' || m.type == 'ma') && m.report_id == this.filtre_report
                });
                return a.reverse()
            },
            messages_u: function () {
        ...
        methods: {
            ...
            myMessage(){
               ...
               if(this.type == 'manager') report_message.type = 'am'
               if(this.type == 'user') report_message.type = 'au'
...
<style scoped src="@/assets/style/messages.css"></style>
<style scoped>
    .content {
