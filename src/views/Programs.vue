                            ...
                            <div class="row m-0 py-2">
                                <div class="col-xl-5">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <h6 class="mb-2">
                                                <b-avatar :src="data.company.logo" class="mr-2"
                                                          alt="Company"></b-avatar>
                                                {{data.company.name}}
                                            </h6>
                                            <h6 class="mb-2"><span class="text-info">Begin At :</span> {{data.begin_at}}
                                            </h6>
                                            ...
                                            <b-badge class="float-right p-2 mr-2" role="button"
                                                     @click="$router.push({name:'ProfilProgram',params:{id:data.id}})"
                                                     pill variant="info">view more
                                            </b-badge>
                                ...
                                <div class="col-xl-3">
                                    <div class="card">
                                        <div class="card-title">
                                            <span class="float-right">{{data.min_bounty+ ' - '+ data.max_bounty}} <i
                                                    class="flaticon-ethereum-2 text-primary ml-1"
                                                    style="font-size: 18px" title="bounty"></i></span>
                                            <h5 class=" mb-0 pt-3 pl-3">Rewards </h5>
                                        </div>
                                        <div class="card-body">
                                            <div class="row m-0">
                                                <span class="col-4">P1</span>
                                                <p class="col-7 p-0 text-center prio">
                                                    {{JSON.parse(data.description).rewards.p1}}</p>
                                            </div>
                                            <div class="row m-0">
                                                <span class="col-4">P2</span>
                                                <p class="col-7 p-0 text-center prio">
                                                    {{JSON.parse(data.description).rewards.p2}}</p>
                                            </div>
                                            <div class="row m-0">
                                                <span class="col-4">P3</span>
                                                <p class="col-7 p-0 text-center prio">
                                                    {{JSON.parse(data.description).rewards.p3}}</p>
                                            </div>
                                            <div class="row m-0">
                                                <span class="col-4">P4</span>
                                                <p class="col-7 p-0 text-center prio">
                                                    {{JSON.parse(data.description).rewards.p4}}</p>
                                            </div>
                                            <div class="row m-0">
                                                <span class="col-4">P5</span>
                                                <p class="col-7 p-0 text-center prio">
                                                    {{JSON.parse(data.description).rewards.p5}}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
